...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/plugins/metisMenu/dist/metisMenu.css') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('assets/fonts/fonts/pe-icon-7-stroke/css/helper.css') }}" />
    ...
    <!-- bootstrap-fileinput-master (INPUTS TIPO FILE) -->
    <link rel="stylesheet" href="{{ asset('assets/plugins/bootstrap-fileinput-master/css/fileinput.css') }}" />
